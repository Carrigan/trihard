...
Elm.Login.make = function (_elm) {
   ...
   _U.list([]),
   _U.list([A2($Html.div,
           _U.list([A2($Html$Attributes.attribute,"class","modal-body")]),
           _U.list([A2($Html.label,_U.list([]),_U.list([$Html.text("Email or Username")]))
                   ,A2($Html.input,_U.list([A2($Html$Attributes.attribute,"class","form-control"),$Html$Attributes.id("username")]),_U.list([]))
                   ,A2($Html.label,_U.list([]),_U.list([$Html.text("Password")]))
                   ,A2($Html.input,
                   _U.list([A2($Html$Attributes.attribute,"class","form-control"),$Html$Attributes.type$("password"),$Html$Attributes.id("password")]),
                   _U.list([]))]))
           ,A2($Html.div,
           _U.list([A2($Html$Attributes.attribute,"class","modal-footer")]),
           _U.list([A2($Html.button,_U.list([A2($Html$Attributes.attribute,"class","btn btn-primary")]),_U.list([$Html.text("Login")]))]))]));
   return _elm.Login.values = {_op: _op,main: main};
};
